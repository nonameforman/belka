          ...
          var f = {
            keyEvent: function (e, t, i, c, u) {
              ...
              if (
                ...
                e.preventDefault(),
                  o.handleRemove.call(p, v, k, y),
                  (0, s.writeBuffer)(
                    v,
                    a.getBuffer.call(p, !0),
                    m.p,
                    e,
                    v.inputmask._valueGet() !== a.getBuffer.call(p).join("")
                  );
                ...
                (k === n.keys.Home && !e.shiftKey) || k === n.keys.PageUp
                  ? (e.preventDefault(),
                    a.caret.call(p, v, 0, e.shiftKey ? y.begin : 0, !0))
                  : d.undoOnEscape && k === n.keys.Escape && !0 !== e.altKey
                  ? ((0, s.checkVal)(v, !0, !1, p.undoValue.split("")),
                    g.trigger("click"))
                  : k !== n.keys.Insert ||
                    e.shiftKey ||
                    e.ctrlKey ||
                    ...
                    ? !0 === e.shiftKey
                      ? ((y.end = a.seekPrevious.call(p, y.end, !0)),
                        ...
                        y.begin >= 0 &&
                          y.end > 0 &&
                          (e.preventDefault(),
                          a.caret.call(p, v, y.begin, y.end)))
              ...
              function s(r, o, c) {
                ...
                if (h === e && void 0 === r.matches) {
                  ...
                  if (r.isGroup && c !== r) {
                    ...
                    if (-1 === j || "string" == typeof j) {
                      ...
                      for (var N = 0; N < R.length; N++) {
                        (A = parseInt(R[N])),
                          (v = []),
                          (i =
                            ("string" == typeof j && m(h, A, T)) || C.slice());
                        var G = _.matches[A];
                    ...
                    for (
                      var z = r, Q = !1, Y = i.length > 0 ? i.shift() : 0;
                      Y <
                        (isNaN(z.quantifier.max) ? Y + 1 : z.quantifier.max) &&
                      h <= e;
                      Y++
                    ) {
          ...
          function s(e, t, i, n, o, l) {
            ...
            if (void 0 !== u) {
              ...
              for (
                ...
                for (
                  S.excludes[v].push(A + ":" + d.alternation), h = v;
                  h < r.getLastValidPosition.call(x, void 0, !0) + 1;
                  h++
                )
                  delete S.validPositions[h];
